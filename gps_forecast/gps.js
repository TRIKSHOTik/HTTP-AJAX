...
function autoLoad(a, b) {
    ...
    httpRequest.open('GET', `http://api.openweathermap.org/data/2.5/forecast?lat=${a}&lon=${b}&units=metric&appid=a94d0a5ac08570add4b47b8da933f247`);
    httpRequest.send();
}
